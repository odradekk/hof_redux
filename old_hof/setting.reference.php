...
define("CRYPT_KEY", (static function () { throw new RuntimeException("Reference only: credential removed"); })());
define("COOKIE_EXPIRE",60*60*24*3);//cookie时间 60*60*24*3
define("UP_PASS", (static function () { throw new RuntimeException("Reference only: credential removed"); })());
